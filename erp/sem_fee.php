...
// Prepare the SQL statement to retrieve semester fee details
$stmt = $conn->prepare('SELECT * FROM sem_fee WHERE enrollment = ?');
...
if ($result->num_rows > 0) {
    ...
    echo "No semester fee details found for your enrollment.";
    exit();
}
...
<head>
    ...
    <title>Semester Fee Details</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2 style="text-align: center; padding-bottom: 10px;">Semester Fee Details</h2>
        <div class="student">
